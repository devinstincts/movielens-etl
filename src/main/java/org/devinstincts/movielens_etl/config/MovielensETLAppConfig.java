package org.devinstincts.movielens_etl.config;
...
import org.devinstincts.movielens_etl.util.MovielensAppConstants;
 ...
 * <pre>
 * <b>Description : </b>
 * The Spring beans configuration for the Movielens ETL application.
 * 
...
@ComponentScan(basePackages = "org.devinstincts.movielens_etl", excludeFilters = { @ComponentScan.Filter(Configuration.class) })
...
public class MovielensETLAppConfig {
    ...
    public SessionFactory getSessionFactory() throws Exception {
        ...
        factory.setPackagesToScan("org.devinstincts.movielens_etl.entities");
